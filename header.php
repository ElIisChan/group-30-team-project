...
<header class="navigationBar">
	<div class="logo-container">
		<h2><img src="/img/logo.png" height="50" width="62" alt="Sorry. Image Not Available!"></h2>
	</div>


	<div class="login-options">

		<a style='color:white;' href='#'> <svg xmlns='http://www.w3.org/2000/svg' width='26'
		...
		<a href='/Sign-in-page.php' class='link'>Log In</a>
		<a href='/sign-up-page.php' class='link'>Sign up</a>

	</div>
</header>
<header class="nav-menubar">
